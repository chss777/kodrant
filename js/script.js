...
function warn(text) {
    const alertContent = 
    `<div class="col alert alert-warning alert-dismissible d-flex align-items-center" role="alert">
        <h4 id="warning">${text}</h4>
        <button id="onclose" type="button" class="btn-close" aria-label="Close" data-bs-dismiss="alert"></button>
    </div>`;
    attention.style.display = 'block';
    attention.innerHTML = alertContent;
...
function openLetter() {
    main.addEventListener('click', view);
...
function view(e) {
    ...
    main.removeEventListener('click', view);
